...
output "DataSource_Zone_East" { 
  value = data.aws_availability_zones.zones_east
}


output "DataSource_Zone_West" { 
  value = data.aws_availability_zones.zones_west
}
